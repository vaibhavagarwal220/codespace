...
<head>
	...
	<title>CodeSpace|An Online Judge</title>
	
	<!-- [ FONT-AWESOME ICON ] 
        =========================================================================================================================-->
	<link rel="stylesheet" type="text/css" href="library/font-awesome-4.3.0/css/font-awesome.min.css">

	<!-- [ PLUGIN STYLESpaceEET ]
        =========================================================================================================================-->
      ...
      <div class="container">
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
            ...
            <a class="navbar-brand" href="index.html">Code<span class="themecolor">Space</span></a>
        </div>
    ...
    <div class="overlay">
            <div class="container">
                <div class="sectionTitle center">
                    <h3>This is  <strong>our team</strong></h3>
                    <div class="line">
                        <hr>
                    </div>
                </div>
                ...
                <div class="mdl-grid">
                    <div class="item mdl-cell mdl-cell-4-col">
                        <div class="thumbnail">
                            <img src="images/team/01.jpg" alt="..." class="img-circle team-img">
                            <div class="caption">
                                <h4>Vaibhav Agarwal</h4>
                                <p>Member</p>
                                <p></p>
                            </div>
                        </div>
...
<br><br><br>
  ...
  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input" type="password" name="pword1" id="p1">
...
<div class="mdl-cell mdl-cell--4-col">    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
