...
echo "<a href=\"subm.php?q=".$qcode."&id=".getfield('username')."\" class=\"mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent\" target=_blank>My submissions</a>";
sucsub($qcode);
echo "</div>";
}
?>
