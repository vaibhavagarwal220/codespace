SELECT * from contests where TIMESTAMPDIFF(MINUTE,NOW(),concat(sdate,concat(' ',stime)) )%60=2 AND TIMESTAMPDIFF(HOUR,NOW(),concat(sdate,concat(' ',stime)) )%24=0 AND TIMESTAMPDIFF(DAY,NOW(),concat(sdate,concat(' ',stime)) )%60=0 AND TIMESTAMPDIFF(SECOND,NOW(),concat(sdate,concat(' ',stime)) )%60=0
