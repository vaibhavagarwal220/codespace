...
if($result&&$num) 
    ...
    for($i=0;$i<$num;$i++)
      ...
      if($totalnum==0) $acc=0; 
			...
			echo "<tr>";
			echo "<td class=\"mdl-data-table__cell--non-numeric \">$qname</td>";
      echo "<td class=\"mdl-data-table__cell--non-numeric\">$qid</td>";
  ...
  else {echo "<h4>No problems uploaded Yet/or Contest has Ended</h4>";
